...
Build the docker image with:
        ...
        docker build -t biblioteca-suindara .
...
exposed port with `docker ps`:
        ...
        docker run --env-file .env --P biblioteca-suindara
        docker ps
...
shell):
        ...
        docker run --env-file .env biblioteca-suindara npm run shell

To run a Django shell inside the container:

        docker run --env-file .env -t biblioteca-suindara
...
In Heroku dashboard, create a new app named `biblioteca-suindara`.
Initialize Heroku remote in the repository:

        heroku git:remote -a biblioteca-suindara
